...
<jsp:include page='WEB-INF/bootstrap/bootstrap.jsp'>
        ...
        <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4" style="text-align: center">
                    ...
                    <p>
                        <a href="https://rikkei.edu.vn/">RIKKEI ACADEMY</a><br>
                        JAVA062022
                    </p>
                </div>
                <!-- Grid column -->
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4" style="text-align: center">
                    ...
                    <p>
                        <a href="https://www.facebook.com/ducmin1001" >Minh Đức</a>
                    </p>
                    <p>
                        <a href="https://www.facebook.com/taphu1998/" >Tạ Phú</a>
                    </p>
                    <p>
                        <a href="https://www.facebook.com/profile.php?id=100004996907432">Trần Nam</a>
                    </p>
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4" style="text-align: center">
                    ...
                    <p>
                        <a href="https://www.facebook.com/profile.php?id=100001884425051" >Nguyễn Đồng Chính</a>
                    </p>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" style="text-align: center">
                    <!-- Links -->
                    <h6 class="text-uppercase fw-bold mb-4">Tutor</h6>
                    <p><a href="https://www.facebook.com/dunghiki" > Lê Việt Dũng</a></p>
